            ...
            <div className="overflow-x-auto">
                <Table>
                    <TableHeader className="h-16">
                        <TableRow>
                            <TableHead className="text-[#475467] text-xs min-w-40">Consultant</TableHead>
                            ...
                            <TableHead className="text-[#475467] text-xs min-w-32">Type transaction</TableHead>
                            <TableHead className="text-[#475467] text-xs min-w-24">Statut</TableHead>
                            <TableHead className="text-[#475467] text-xs min-w-32">Statut consultant</TableHead>
                            <TableHead className="text-[#475467] text-xs min-w-28">Montant brut</TableHead>
                            <TableHead className="text-[#475467] text-xs min-w-28">Montant net</TableHead>
