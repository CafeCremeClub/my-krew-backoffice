    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, {resetForm}) => {
            try {
                ...
                toast.error("Une erreur est survenue lors de la mise à jour du rôle du consultant.", {
                    position: "bottom-right",
        ...
        >
            <DialogContent
                ...
                <div className="bg-white rounded-2xl overflow-hidden flex flex-col gap-10 py-6 px-2">
                    <DialogHeader>
                        <DialogTitle>
                            Modifier le rôle du la consultant {consultant.firstname + " " + consultant.lastname}
                        </DialogTitle>
                        <DialogDescription>
                            Modifiez le rôle du consultant en sélectionnant un nouveau rôle dans la liste ci-dessous.
                        </DialogDescription>
                    </DialogHeader>
