...
const ImportConsultantsCSVDialog = ({isOpen, onClose, page}: ImportCSVDialogProps) => {
                ...
                try {
                    ...
                    if (results.errors.length > 0) {
                        const parseErrors = results.errors.map(error =>
                            `Ligne ${error.row !== undefined ? error.row + 2 : 'inconnue'}: ${error.message}`
                        );
                    ...
                    const {validData, errors: validationErrors} = validatePayload(dataWithRowIndex);
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            ...
                            <div className="text-sm text-green-800">
                                ...
                                <div className="bg-white p-2 rounded border text-xs">
                                    ...
                                    {csvData.length > 3 && (
                                        <div className="text-gray-500">... et {csvData.length - 3} autres</div>
                                    )}
                                </div>
                            </div>
                        </div>
