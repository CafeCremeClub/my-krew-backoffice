    ...
    const handleDelete = async () => {
        try {
            ...
            toast.error("Échec de la suppression du consultant", {
                description: "Une erreur s'est produite lors de la suppression du consultant. Veuillez réessayer.",
                position: "bottom-right",
    ...
    return (
        <AlertDialog open={open} onOpenChange={onClose}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>
                        Confirmer la suppression du consultant {consultant.firstname} {consultant.lastname}
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                        Êtes-vous sûr de vouloir supprimer ce consultant ?<br/>
                        Cette action est irréversible et entraînera la suppression de toutes les données associées à ce
                        consultant.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
