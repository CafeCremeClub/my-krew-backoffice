...
export const signup = async (payload: SigninPayload): Promise<SigninResponse> => {
    try {
...
export const updateUserDetails = async (payload: UpdateUserDetailsPayload): Promise<void> => {
    try {
